...
| AJGraphing Calculator | The graph draws itself by using [recursion in paint](https://github.com/AidanRosen/HexPass-Portfolio-Vector-IDEA/blob/98e69fd18d8d0adcdbb649820c658a51070ab714/src/AJGraphingCalculator/View/TheGraph.java#L55)
...
| AJGraphing Calculator | [Generating the graph using iteration and paint](https://github.com/AidanRosen/HexPass-Portfolio-Vector-IDEA/blob/98e69fd18d8d0adcdbb649820c658a51070ab714/src/AJGraphingCalculator/View/TheGraph.java#L55)
| AJGraphing Calculator | [Seperating](https://github.com/AidanRosen/HexPass-Portfolio-Vector-IDEA/blob/98e69fd18d8d0adcdbb649820c658a51070ab714/src/AJGraphingCalculator/Model/Seperator.java#L161) the function
| AJGraphing Calculator | [handling the function](https://github.com/AidanRosen/HexPass-Portfolio-Vector-IDEA/blob/98e69fd18d8d0adcdbb649820c658a51070ab714/src/AJGraphingCalculator/Model/Point.java#L32) by using the newly generated object to get values as a point on a graph
...
| Alex | Andrew Hale: Alex did an amazing job. He always responded quickly to slack messages and never ceased to deviver. Alex was responsible for most of the creation of our [N@TM Section](http://ntm.nighthawkcoders.cf/period1/). 5/5 | Andrew Joseph: Alex worked with me to create a comprehensive outline of our plan for what the graphing calculator was going to look like. Though we did create seperate graphing calculators, this plan still was at least partially incorporated to both of our designs. [Plan](https://docs.google.com/presentation/d/1WK289219G0Ghy-Gx8RGlxnLjarwmvXKdLWXgoxYw74c/edit#slide=id.ga37d9b1d11_2_35) 5/5. |
| Atharva | Andrew Hale: During zoom calls Atharva was always working to help. His project with Alex is super cool and his part in the [video](https://drive.google.com/file/d/1phIvOBFDWPhBOPkg7f3a6cDzGLOLfMEJ/view?usp=sharing) is well made. However, he is not the best at responding to slack messages. 4/5 | Andrew Joseph: Atharva worked well with everyone to help resolve issues, he frequently worked in slack to stay up to date with everything, and helped to make sure everyone knew what was happening. 5/5.
