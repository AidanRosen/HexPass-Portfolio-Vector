...
public class FnStorer {
    ...
    private AJGraphingCalculator.Model.Math.OPERATOR operator;
    ...
    public AJGraphingCalculator.Model.Math.OPERATOR setOperator(AJGraphingCalculator.Model.Math.OPERATOR op) {
        this.operator = op;
        return operator;
    }
    ...
    public AJGraphingCalculator.Model.Math.OPERATOR getOperator() {
        return operator;
    }
    ...
    public FnStorer(double firstnber, AJGraphingCalculator.Model.Math.OPERATOR op, double secondnber) {
    ...
    public void setOrder(AJGraphingCalculator.Model.Math.OPERATOR op) {
        switch (op) {
