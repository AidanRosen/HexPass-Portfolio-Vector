...
public class FnStorer {
    ...
    private src.ModelAJGC.Math.OPERATOR operator;
    ...
    public src.ModelAJGC.Math.OPERATOR setOperator(src.ModelAJGC.Math.OPERATOR op) {
        this.operator = op;
        return operator;
    }
    ...
    public src.ModelAJGC.Math.OPERATOR getOperator() {
        return operator;
    }
    ...
    public FnStorer(double firstnber, src.ModelAJGC.Math.OPERATOR op, double secondnber) {
    ...
    public void setOrder(src.ModelAJGC.Math.OPERATOR op) {
        switch (op) {
