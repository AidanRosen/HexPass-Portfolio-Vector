...
public class AJGraphingCalculatorUI extends JFrame {
...
*/
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(() -> {
            try {
                src.ViewAJGC.AJGraphingCalculatorUI frame = new src.ViewAJGC.AJGraphingCalculatorUI();
